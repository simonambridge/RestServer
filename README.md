...
```
The same data returned with an HTML wrapper to make it readable:
```
...
The ReST interface provides a handy status page. 

###HTML File Status Page
This also shows you how to bring in additional *.html file content.
```
http://127.0.0.1:7001/restserver/resources/index.html
```

###HTML Generated By Java
This page is generated as a ReST reponse but padded with HTML so as to create an HTML page
```
